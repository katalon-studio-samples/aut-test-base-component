...
import {
  Stack,
  AccordionSummary as StyledAccordionSummary,
} from "@mui/material";
    ...
    <Stack direction="column" spacing={5} className="px-4 py-6 sm:px-0">
      <Accordion>
        ...
        <AccordionDetails>
          ...
          <p className="mb-6">
            Practice working with iframes, including nested elements and
      ...
      <Accordion>
        ...
        <AccordionDetails>
          ...
          <div
            ...
            data-test="iframe-wrapper-educenter"
          >
      ...
      <Accordion>
        ...
        <AccordionDetails>
          <div
            className="border rounded-lg p-4 mt-10"
            data-test="iframe-wrapper-educenter"
          >
            <h3 className="text-lg font-medium mb-2">Iframe Center</h3>
            <iframe
