...
export const SauceLoginPage: React.FC = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        const userCredential = VALID_CREDENTIALS[credentials.username as keyof typeof VALID_CREDENTIALS];
                    ...
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="flex justify-between items-center h-16">
                            <div className="flex items-center">
                                <h1 className="text-xl font-semibold text-gray-900">Sauce Demo</h1>
                            </div>
                            <div className="flex items-center space-x-8">
                                <div className="relative flex items-center justify-center">
                                    <button
                                        className="p-2 text-gray-600 hover:text-gray-900 flex items-center justify-center">
                                            ...
                                            {item.image ? (
                                                ...
                                                <div
                                                    ...
                                                    <div className="text-center">
                                                        ...
                                                        <div
                                                            className="text-sm text-gray-600 font-medium">{item.name}</div>
                                                    </div>
                                                </div>
                                            )}
                                        </div>
        ...
        <div className="min-h-screen bg-gray-50 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
            <div className="max-w-md w-full space-y-8">
                ...
                <div className="bg-white p-8 rounded-lg shadow-md">
                    <form onSubmit={handleSubmit} className="space-y-6" data-test="auth-form">
                        <div>
                            ...
                            <div className="bg-red-50 border border-red-200 rounded-md p-4 relative"
                                ...
                                <div className="flex">
                                    <div className="flex-shrink-0">
                                        <svg className="h-5 w-5 text-red-400" fill="none" stroke="currentColor"
                                             viewBox="0 0 24 24">
                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}
                    ...
                    <div className="mt-6">
                        <div className="bg-blue-50 border border-blue-200 rounded-md p-4">
                            <h3 className="text-sm font-medium text-blue-800 mb-2">Available Test Credentials:</h3>
                            <div className="text-sm text-blue-700 space-y-1">
                                <p><strong>standard_user</strong> - Normal user access</p>
                                <p><strong>locked_out_user</strong> - Locked out user (will show error)</p>
                                <p><strong>problem_user</strong> - User with UI issues</p>
                                <p><strong>performance_glitch_user</strong> - User with slow loading</p>
                                <p className="text-xs mt-2">Password for all users: <strong>secret_sauce</strong></p>
                            </div>
                        </div>
                    </div>
                </div>
