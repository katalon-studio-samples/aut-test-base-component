    ...
    <div className="p-8 max-w-6xl mx-auto">
      ...
      <div className="mb-6 p-4 bg-red-50 dark:bg-red-900/20 rounded-lg">
        <p className="text-sm text-red-700 dark:text-red-300 mb-2">
          ⚠️ This page contains elements with characters that commonly break XPath selectors:
        </p>
      ...
      <div className="space-y-8">
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <button
                ...
                onClick={() => handleElementClick("Button with single quotes in data-testid and title")}
              >
                Single Quote Button
              </button>
              ...
              <input
                ...
                onClick={() => handleElementClick("Input with double quotes in multiple attributes")}
              />
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div
                ...
                onClick={() => handleElementClick("Div with both single and double quotes")}
              >
              ...
              <span
                ...
                onClick={() => handleElementClick("Span with apostrophes and quotes in realistic context")}
              >
          ...
          <div className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <button
                ...
                data-index="[0]"
                onClick={() => handleElementClick("Button with square brackets in ID and class")}
              >
                Array[0] Button
              </button>
              ...
              <input
                ...
                onClick={() => handleElementClick("Input with parentheses in ID and class")}
              />
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div
                ...
                onClick={() => handleElementClick("Element with mixed brackets and parentheses")}
              >
              ...
              <select
                ...
                onClick={() => handleElementClick("Select with brackets in multiple attributes")}
              >
          ...
          <div className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <button
                ...
                onClick={() => handleElementClick("Button with ampersands in data-testid")}
              >
                Save &amp; Exit
              </button>
              ...
              <div
                ...
                onClick={() => handleElementClick("Div with less-than symbol in attributes")}
              >
                Value &lt; 100
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <input
                ...
                className="px-3 py-2 border border-gray-300 dark:border-gray-600 rounded dark:bg-gray-700 dark:text-gray-200"
                onClick={() => handleElementClick("Input with greater-than symbol in attributes")}
              />
              ...
              <span
                ...
                onClick={() => handleElementClick("Span with mixed XML special characters")}
              >
                Formula: a &amp; b &lt; c &gt; d
              </span>
            </div>
          ...
          <div className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div
                ...
                onClick={() => handleElementClick("Element with namespace colons in data attributes")}
              >
                Namespace Element
              </div>
              ...
              <button
                ...
                onClick={() => handleElementClick("Button with custom namespace attributes")}
              >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <input
                ...
                className="px-3 py-2 border border-gray-300 dark:border-gray-600 rounded dark:bg-gray-700 dark:text-gray-200"
                onClick={() => handleElementClick("Input with XML namespace attributes")}
              />
              ...
              <select
                ...
                className="px-3 py-2 border border-gray-300 dark:border-gray-600 rounded dark:bg-gray-700 dark:text-gray-200"
                onClick={() => handleElementClick("Select with multiple namespace attributes")}
              >
          ...
          <div className="space-y-4">
            <div className="grid grid-cols-1 gap-4">
              <button
                ...
                onClick={() => handleElementClick("NIGHTMARE ELEMENT: All problematic characters combined")}
              >
                🔥 Nightmare Element: 'quotes' &amp; [brackets] (parens) &lt; &gt; symbols
              </button>
              
              <div
                id="div[array]'quote'&lt;xml&gt;"
                className={'extreme-case\'with"quotes&[brackets](parens)'}
                data-testid={'extreme-\'case\'-with-"all"-&-[problematic]-(characters)'}
                title={'Extreme case with \'all\' "problematic" & [characters] (combined) < together >'}
                data-app:config={'test\'data"with&special<chars>'}
                onClick={() => handleElementClick("EXTREME CASE: Maximum XPath complexity")}
              >
        ...
        {selectedElement && (
          <section className="border border-green-300 dark:border-green-600 rounded-lg p-6 bg-green-50 dark:bg-green-900/10">
            ...
            <p className="text-green-700 dark:text-green-300">{selectedElement}</p>
            <div className="mt-3 text-sm text-green-600 dark:text-green-400">
              <p><strong>XPath Challenge:</strong> This element requires careful XPath escaping or alternative locator strategies.</p>
            </div>
          </section>
        )}
        ...
        <section className="border border-blue-300 dark:border-blue-600 rounded-lg p-6 bg-blue-50 dark:bg-blue-900/10">
          ...
          <div className="space-y-3 text-sm font-mono">
            <div>
              <p className="text-blue-700 dark:text-blue-300 mb-1"><strong>Single Quote Problem:</strong></p>
            ...
            <div>
              <p className="text-blue-700 dark:text-blue-300 mb-1"><strong>Double Quote Problem:</strong></p>
              <p className="bg-red-100 dark:bg-red-900/30 p-2 rounded text-red-700 dark:text-red-300">
            ...
            <div>
              <p className="text-blue-700 dark:text-blue-300 mb-1"><strong>Mixed Quotes Problem:</strong></p>
              <p className="bg-red-100 dark:bg-red-900/30 p-2 rounded text-red-700 dark:text-red-300">
                ❌ //span[@title="John's Profile - "Admin" Role"]
              </p>
              <p className="bg-green-100 dark:bg-green-900/30 p-2 rounded text-green-700 dark:text-green-300">
                ✅ //span[@title=concat("John's Profile - ", '"', "Admin", '"', " Role")]
              </p>
            </div>
            
            <div>
              <p className="text-blue-700 dark:text-blue-300 mb-1"><strong>Brackets in ID:</strong></p>
              <p className="bg-red-100 dark:bg-red-900/30 p-2 rounded text-red-700 dark:text-red-300">
                ❌ //button[@id='btn[array-style]'] (works but may be fragile)
              </p>
              <p className="bg-green-100 dark:bg-green-900/30 p-2 rounded text-green-700 dark:text-green-300">
                ✅ //button[contains(@id, 'btn') and contains(@id, 'array-style')]
              </p>
            </div>
          </div>
        </section>
